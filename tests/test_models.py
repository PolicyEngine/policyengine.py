...
class TestUKModel:
    ...
    def test_has_release_manifest_metadata(self):
        ...
        assert uk_latest.model_package.version == "2.90.2"
        assert uk_latest.data_package.name == "policyengine-uk-data"
        assert uk_latest.data_package.version == "1.56.16"
        assert (
...
class TestUSModel:
    ...
    def test_has_release_manifest_metadata(self):
        ...
        assert us_latest.model_package.version == "2.0.0"
        assert us_latest.data_package.name == "microcosm-data"
        assert us_latest.data_package.version == "0.1.0"
        assert (
            us_latest.default_dataset_uri
            == "hf://policyengine/populace-us/populace_us_2024.h5"
            "@populace-us-2024-spm-20260909"
        )
