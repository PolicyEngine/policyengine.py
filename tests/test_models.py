...
class TestUKModel:
    ...
    def test_has_release_manifest_metadata(self):
        ...
        assert uk_latest.model_package.version == "2.88.6"
        assert uk_latest.data_package.name == "policyengine-uk-data"
        assert uk_latest.data_package.version == "1.53.0"
        assert (
...
class TestUSModel:
    ...
    def test_has_release_manifest_metadata(self):
        ...
        assert us_latest.model_package.version == "1.687.0"
        assert us_latest.data_package.name == "policyengine-us-data"
        assert us_latest.data_package.version == "1.78.2"
        assert (
