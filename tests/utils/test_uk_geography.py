...
class TestDetermineUKRegionType:
    ...
    def test_country_region(self):
        ...
        assert (
            determine_uk_region_type("country/northern_ireland") == "country"
        )

    def test_constituency_region(self):
        """Test parsing constituency region strings."""
        assert (
            determine_uk_region_type("constituency/Aberdeen North")
            == "constituency"
        )
        assert (
            determine_uk_region_type("constituency/S14000001")
            == "constituency"
        )
    ...
    def test_local_authority_region(self):
        ...
        assert (
            determine_uk_region_type("local_authority/leicester")
            == "local_authority"
        )
        assert (
            determine_uk_region_type("local_authority/E06000016")
            == "local_authority"
        )
...
class TestShouldZeroConstituency:
    ...
    def test_uk_wide_never_zeros(self):
        ...
        assert (
            should_zero_constituency(None, "S14000001", "Aberdeen North")
            is False
        )
        assert (
            should_zero_constituency(None, "E14000001", "Some English")
            is False
        )
        assert (
            should_zero_constituency(None, "W07000001", "Some Welsh") is False
        )
    ...
    def test_country_filter_keeps_matching_country(self):
        ...
        assert (
            should_zero_constituency(
                "country/scotland", "S14000001", "Aberdeen North"
            )
            is False
        )
        ...
        assert (
            should_zero_constituency(
                "country/england", "E14000001", "Some English"
            )
            is False
        )
    ...
    def test_country_filter_zeros_other_countries(self):
        ...
        assert (
            should_zero_constituency(
                "country/scotland", "E14000001", "Some English"
            )
            is True
        )
        ...
        assert (
            should_zero_constituency(
                "country/england", "S14000001", "Aberdeen North"
            )
            is True
        )
        ...
        assert (
            should_zero_constituency(
                "country/scotland", "W07000001", "Some Welsh"
            )
            is True
        )
    ...
    def test_constituency_filter_keeps_matching_by_code(self):
        ...
        assert (
            should_zero_constituency(
                "constituency/S14000001", "S14000001", "Aberdeen North"
            )
            is False
        )
    ...
    def test_constituency_filter_keeps_matching_by_name(self):
        ...
        assert (
            should_zero_constituency(
                "constituency/Aberdeen North", "S14000001", "Aberdeen North"
            )
            is False
        )
    ...
    def test_constituency_filter_zeros_non_matching(self):
        ...
        assert (
            should_zero_constituency(
                "constituency/Aberdeen North", "S14000002", "Aberdeen South"
            )
            is True
        )
        assert (
            should_zero_constituency(
                "constituency/S14000001", "E14000001", "Some English"
            )
            is True
        )
    ...
    def test_local_authority_filter_zeros_all_constituencies(self):
        ...
        assert (
            should_zero_constituency(
                "local_authority/leicester", "S14000001", "Aberdeen North"
            )
            is True
        )
        assert (
            should_zero_constituency(
                "local_authority/leicester", "E14000001", "Some English"
            )
            is True
        )
        assert (
            should_zero_constituency(
                "local_authority/E06000016", "W07000001", "Some Welsh"
            )
            is True
        )
...
class TestShouldZeroLocalAuthority:
    ...
    def test_uk_wide_never_zeros(self):
        ...
        assert (
            should_zero_local_authority(None, "E06000016", "Leicester")
            is False
        )
        assert (
            should_zero_local_authority(None, "S12000033", "Aberdeen") is False
        )
        assert (
            should_zero_local_authority(None, "W06000001", "Some Welsh LA")
            is False
        )
    ...
    def test_country_filter_keeps_matching_country(self):
        ...
        assert (
            should_zero_local_authority(
                "country/scotland", "S12000033", "Aberdeen"
            )
            is False
        )
    ...
    def test_country_filter_zeros_other_countries(self):
        ...
        assert (
            should_zero_local_authority(
                "country/england", "S12000033", "Aberdeen"
            )
            is True
        )
    ...
    def test_local_authority_filter_keeps_matching_by_code(self):
        ...
        assert (
            should_zero_local_authority(
                "local_authority/E06000016", "E06000016", "Leicester"
            )
            is False
        )
    ...
    def test_local_authority_filter_zeros_non_matching(self):
        ...
        assert (
            should_zero_local_authority(
                "local_authority/Leicester", "E06000017", "Rutland"
            )
            is True
        )
        assert (
            should_zero_local_authority(
                "local_authority/E06000016", "S12000033", "Aberdeen"
            )
            is True
        )
    ...
    def test_constituency_filter_zeros_all_local_authorities(self):
        ...
        assert (
            should_zero_local_authority(
                "constituency/Aberdeen North", "S12000033", "Aberdeen"
            )
            is True
        )
        assert (
            should_zero_local_authority(
                "constituency/S14000001", "W06000001", "Some Welsh LA"
            )
            is True
        )
