...
PolicyEngine is built on the PolicyEngine Core framework, which extends the OpenFisca microsimulation engine. The `policyengine` package is organized as a country-agnostic layer with the following core components:
