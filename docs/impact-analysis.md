...
|---|---|---|
| `decile_impacts` | `OutputCollection[DecileImpact]` | Household net income baseline / reform / change and winner-loser counts per person-weighted income decile; negative-income rows are excluded from reported deciles |
