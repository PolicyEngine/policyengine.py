...
def create_ecps(
    year: int = 2024, sim: "Microsimulation" | None = None
) -> Dataset:
    ...
    tax_unit = pd.DataFrame(
        {
            "tax_unit_id": list(
                range(1201, 1213)
            ),  # 12 tax units across 10 households
    ...
    person = pd.DataFrame(
        {
            ...
            "person_household_id": [
                ...
                100,
                100,
                100,  # Family with 2 children
                101,
                101,  # Working couple
                102,  # Single elderly
                103,
                103,
                103,  # Single parent with 2 kids
                104,
                104,
                104,
                104,  # Low income family
                105,  # High earner
                106,
                106,  # Disabled couple
                107,
                ...
                107,  # Large family
                108,
                108,  # DINK (dual income no kids)
                109,
                109,
                109,  # Middle income family
                101,
                103,
                104,  # Additional people in some households (3 people to make 30 total)
            ],
            "person_spm_unit_id": [
                1301,
                1301,
            ...
            "person_tax_unit_id": [
                ...
                1209,
                1209,
                1209,  # Large family has 2 tax units
                1210,
                1210,
                1211,
                1211,
            ...
            "employment_income": [
                ...
                0,
                0,
                0,  # Additional dependents (3 people)
            ],
            "social_security": [
                0,
                0,
