...
def create_efrs(
    year: int = 2029, sim: "Microsimulation" | None = None
) -> Dataset:
    ...
    person = pd.DataFrame(
        {
            ...
            "person_benunit_id": [
                ...
                10,
                10,
                10,  # Family with 2 children
                11,
                11,  # Working couple
                12,  # Single pensioner
                13,
                13,
                13,  # Single parent with 2 children
                14,
                14,  # Disabled couple
                15,  # High earner
                16,
                16,  # Low income couple
                17,
                17,
                17,
                17,  # Large family
                ...
                19,
                19,
                19,  # Middle income family (added 1 more person)
            ],
            "person_household_id": [
                100,
                100,
                100,
                100,  # Family household
                101,
                101,  # Working couple household
                102,  # Single pensioner
                103,
                103,
                103,  # Single parent household
                104,
                104,  # Disabled couple
                105,  # High earner
                106,
                106,  # Low income couple
                107,
                107,
                107,
                107,  # Large family
                ...
                109,
                109,
                109,  # Middle income family (added 1 more person)
            ],
            "age": [
                35,
                33,
            ...
            "employment_income": [
                ...
                20000,
                0,
                0,  # Parents working, children none
                45000,
                38000,  # Both working
                0,  # Pensioner
                18000,
                0,
                0,  # Single parent working
                0,
                0,  # Disabled
                120000,  # High earner
                12000,
                ...
                30000,
                0,
                0,  # Middle income (added child with 0 income)
            ],
            "pension_income": [
                0,
                0,
            ...
            "self_employment_income": [
                ...
                5000,
                0,
                0,  # One parent has some self-employment
                0,
                0,
                0,
                3000,
                0,
                0,  # Single parent has some self-employment
                0,
                0,
                0,
                0,
            ...
            "is_disabled": [
                ...
                False,
                True,
                False,  # One disabled child
                False,
                False,
                False,
                False,
                False,  # Added one more False
            ],
