...
yaml_file_path = "policyengine/tests/economic_impact/distributional_impact/by_wealth/relative/relative.yaml"
...
def test_economic_impact(test_case):
    ...
    if 'relative' in test_name:
        result = economic_impact.calculate("distributional/by_wealth/relative")
    else:
