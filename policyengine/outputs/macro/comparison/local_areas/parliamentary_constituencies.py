...
def parliamentary_constituencies(simulation: Simulation) -> dict:
    ...
    constituency_baseline = simulation.calculate("macro/baseline/gov/local_areas/parliamentary_constituencies")
    constituency_reform = simulation.calculate("macro/reform/gov/local_areas/parliamentary_constituencies")
    ...
    for constituency in constituency_baseline:
        ...
        for key in constituency_baseline[constituency]:
            result[constituency][key] = {
                "change": constituency_reform[constituency][key] - constituency_baseline[constituency][key],
