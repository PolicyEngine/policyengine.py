    ...
    for age_group in ["child", "working_age", "senior", "all"]:
        ...
        for racial_group in racial_groups:
            ...
            for relative in [True, False]:
                for poverty_rate in ["uk_hbai_bhc", "uk_hbai_bhc_half", "us_spm", "us_spm_half"]:
                    ...
                    if poverty_rate == "uk_hbai_bhc":
                        ...
                        in_poverty = simulation.calculate("in_deep_poverty", map_to="person")
                    ...
                    total_in_group_in_poverty = (in_group * in_poverty * person_weight).sum()
                    if relative:
                        result = total_in_group_in_poverty / total_in_group
                    else:
                        result = total_in_group_in_poverty
                    
                    poverty_metrics.append(PovertyRateMetric(
                        age_group=age_group,
