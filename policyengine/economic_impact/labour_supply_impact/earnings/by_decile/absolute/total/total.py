...
class IncomeEffect(BaseMetricCalculator):
    ...
    def calculate(self):
        ...
        decile_rel["income"] = {int(k): v * 100 for k, v in decile_rel["income"].items() if k > 0}
...
class Total(BaseMetricCalculator):
    ...
    def calculate(self):
        ...
        income_dict = income_result['decile_avg']["income"]
        substitution_dict = substitution_result['decile_avg']["substitution"]
